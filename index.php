<?php 
    $your_email ='admin@hartspartyhire.com.au';// <<=== update to your email address
...
<div id="container">
        ...
        <div class="info">
            ...
            4. Within 24 hours of the site inspection our marquee specialist will email you your accurate fixed quote.</div>
                ...
                <ul class="gal"><li><img src="marquees/5.JPG"/></li><li><img src="marquees/3.jpg"/></li><li><img src="marquees/4.jpg"/></li></ul>
                
            <div class="clearbottom"><br />
            
            </div>
            
            <a class="fancybox" href="#myfcbox"><div class="startbt"></div></a>
            <div style="clear: both;"></div>
            <p>"With more than 300 marquees sizes we can provide the marquee to suit your event, large or small."</p>
                <p>"Marquees to suit all event styles from back yards to corporate events and festivals."</p>
        </div>
		...
		<div id="steps">
			...
			<div class="step">
				...
				<div class="divchild notranslate leftHalf" id="fo8li33">
					...
					<span>
						<input type="text" placeholder="First name"  tabindex="12" size="8" value="" class="field text fn" name="Field33" id="Field33"/>
						<label for="Field33"></label>
					</span>
					<span>
						<input type="text" placeholder="Last name"    tabindex="13" size="14" value="" class="field text ln" name="Field34" id="Field34"/>
				...
				<div class="divchild date notranslate rightHalf" id="fo8li36">
					...
					<div>
						<input style="text-align: left;" type="text"    tabindex="17" maxlength="255" value="" class="field text medium" spellcheck="false" name="Field36" id="Field36"/> 
					</div>
                     <script>
                        $(function() {
				...
				<div class="divchild notranslate leftHalf" id="fo8li38">
					...
					<div>
						<input type="email"    tabindex="14" maxlength="255" value="" class="field text medium" spellcheck="false" name="Field38" id="Field38"/> 
					</div>
				</div>
				...
				<div class="divchild notranslate leftHalf" id="fo8li42">
					...
					<div>
						<input type="tel" value="" maxlength="255"    tabindex="15" name="Field42" class="field text medium" id="Field42"/> 
					</div>
				...
				<div class="divchild notranslate leftHalf" id="fo8li44">
					...
					<div>
						<input type="text"    tabindex="16" maxlength="255" value="" class="field text medium" name="Field44" id="Field44"/>
					</div>
    ...
    frmvalidator.addValidation("Field33","req","You didn't provide your first name. Please go back Step 3!");
    frmvalidator.addValidation("Field34","req","You didn't provide your last name. Please go back Step 3!"); 
    frmvalidator.addValidation("Field38","req","You didn't provide your email. Please go back Step 3!"); 
    frmvalidator.addValidation("Field38","email","You didn't enter a valid email address. Please go back Step 3!");
    frmvalidator.addValidation("Field42","req","You didn't provide your phone number. Please go back Step 3!");     
    frmvalidator.addValidation("Field42","numeric","You didn't enter a valid phone number. Please go back Step 3!");
    frmvalidator.addValidation("Field44","req","You didn't provide delivery location. Please go back Step 3!");
    frmvalidator.addValidation("Field36","req","You didn't provide function date. Please go back Step 3!");  
</script>
</div>
...
try {
reinvigorate.track("o9wz0-08p0z7y9l9");
} catch(err) {}
</script>
</body>
</html>
